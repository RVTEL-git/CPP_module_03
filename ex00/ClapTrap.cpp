...
/*   Updated: 2025/12/19 12:36:20 by barmarti         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::beRepaired( unsigned int amount )
{
	if (this->_hitPoints == 0)
	{
		std::cout << "ClapTrap " << _name << " has no hit point so it can't repair itself" << std::endl;
		return ;
	}
	if (this->_energyPoints == 0)
	{
		std::cout << "ClapTrap " << _name << " has no energy point point so it can't repair itself" << std::endl;
		return ;
	}
	else
	{
